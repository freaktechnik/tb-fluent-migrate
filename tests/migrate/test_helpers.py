...
class TestTransformsFrom(unittest.TestCase):
    def assert_transforms_equal(self, parsed, expected):
        return self.assertTrue(
            all(actual.equals(ast) for actual, ast in zip_longest(parsed, expected)),
            """\
...
{}
""".format(
                [msg.to_json() for msg in parsed], [msg.to_json() for msg in expected]
            ),
        )
        ...
        self.assert_transforms_equal(
            ...
            [
                FTL.Message(
                    ...
                    value=CONCAT(FTL.TextElement("Hardcoded value.")),
                )
            ],
        )
        ...
        self.assert_transforms_equal(
            ...
            [
                ...
                FTL.Message(
                    ...
                    value=CONCAT(FTL.TextElement("Another value.")),
                ),
            ],
        )
            ...
            [
                FTL.Message(
                    ...
                    value=CONCAT(
                        ...
                        FTL.Placeable(
                            FTL.MessageReference(FTL.Identifier("message-reference"))
                        ),
            ...
            [
                FTL.Message(
                    ...
                    value=CONCAT(
                        FTL.TextElement("Prefix "),
                        FTL.Placeable(
                            FTL.VariableReference(FTL.Identifier("argument"))
                        ),
                        FTL.TextElement(" postfix."),
                    ),
                )
                            ...
                            FTL.SelectExpression(
                                ...
                                variants=[
                                    FTL.Variant(
                                        ...
                                        default=False,
                                        value=CONCAT(FTL.TextElement("macOS")),
                                    ),
                                    FTL.Variant(
                                        key=FTL.Identifier("other"),
                                        default=True,
                                        value=CONCAT(FTL.TextElement("Other")),
                                    ),
                                ],
                            )
                        ),
...
"""
        ...
        self.assert_transforms_equal(
            ...
            [
                FTL.Message(
                    id=FTL.Identifier("new-key"),
                    value=CONCAT(FTL.TextElement("Block value\ncontinued.")),
                )
            ],
        )
...
"""
        ...
        self.assert_transforms_equal(
            ...
            [
                FTL.Message(
                    id=FTL.Identifier("new-key"), value=CONCAT(COPY("path", "key"))
                )
            ],
        )
...
"""
        ...
        self.assert_transforms_equal(
            ...
            [
                FTL.Message(
                    id=FTL.Identifier("new-key"),
                    value=CONCAT(COPY("path", "key", trim=False)),
                )
            ],
        )
...
"""
        ...
        self.assert_transforms_equal(
            ...
            [
                FTL.Message(
                    id=FTL.Identifier("new-key"),
                    value=CONCAT(COPY("path", "key", trim=True)),
                )
            ],
        )
                            ...
                            FTL.SelectExpression(
                                ...
                                variants=[
                                    FTL.Variant(
                                        key=FTL.Identifier("macos"),
                                        default=False,
                                        value=CONCAT(COPY("path", "key.mac")),
                                    ),
                                    FTL.Variant(
                                        key=FTL.Identifier("other"),
                                        default=True,
                                        value=CONCAT(COPY("path", "key.other")),
                                    ),
                                ],
                            )
                        )
        ...
        self.assert_transforms_equal(
            ...
            [
                FTL.Message(
                    id=FTL.Identifier("new-key"),
                    value=CONCAT(
                        FTL.Placeable(FTL.StringLiteral(value=" ")),
                        FTL.TextElement("postfix."),
                    ),
                )
            ],
